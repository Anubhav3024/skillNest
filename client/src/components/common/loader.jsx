      ...
      <style>
        {`
          ...
          @keyframes loaderColor {
            0% { fill: #0d694f; } /* SkillNest Green */
            50% { fill: #ff7e5f; } /* SkillNest Orange */
            100% { fill: #0d694f; }
          }

          #pen1 { animation: pen1 2s infinite ease; }
          #pen2 { animation: pen2 2s infinite ease; }
          #pen3 { animation: pen3 2s infinite ease; }
          #loader-path { animation: loaderColor 3s infinite ease; }
        `}
      </style>
      <div className="content">
        <svg id="loader" xmlns="http://www.w3.org/2000/svg" width={150} height={150} viewBox="0 -10 261 355">
          <g>
            <path id="loader-path" d="M230.023 80.02l-.023.03v15.044l-11.96.006v20.75l-19.354 9.142V95.107l-9.93-.04v34.6l-19.417 9.254-.003-43.777-14.146-.016v50.414l-19.354 9.146.002-59.55-9.93.027v59.434l-19.508-9.212V95.15l-13.774-.13-.002 43.766-19.332-9.053V95.12l-9.97.045v29.893l-19.398-9.187V95.177l-11.983.006v15.03l-17.122-8.09 17.078-6.983V80.22L.286 95.257 0 95.12v188.953l123.418 58.308 7.543 3.56 7.542-3.56 123.42-58.306V95.12l-.233.11-31.667-15.06zm-.002 15.076l17.126 7.002-17.125 8.09zM15.083 118.93l108.336 51.177v155.59L15.082 274.52zm231.756 0v155.59l-108.336 51.177v-155.59z">
            </path>
